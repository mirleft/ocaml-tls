...
(* OASIS_START *)
(* DO NOT EDIT (digest: 161f2ba6493186b92b34fa2160f48026) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/hannesm/mirage-tls";
          synopsis = "TLS support for mirage";
          description = Some "TLS support on top of mirage";
          categories = [];
     ...
     oasis_version = "0.4.1";
     oasis_digest =
       Some "\239\135\131\133\223\230\223\244\185\210\146\025b\188\027\135";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
