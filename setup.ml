...
(* OASIS_START *)
(* DO NOT EDIT (digest: 92f655498a91d3664b8cb924133cbe58) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Registry"; "Asn_grammars"; "Certificate"; "X509"];
                      lib_pack = false;
     ...
     oasis_version = "0.4.4";
     oasis_digest =
       Some "\229\029Vs\030\206\172\020O\011\021\005\151\144[\164";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
