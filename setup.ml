...
(* OASIS_START *)
(* DO NOT EDIT (digest: c58035a087f65d552c682d31855eaa7a) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = true;
                      lib_internal_modules = ["Registry"; "Asn_grammars"];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\158\150:\201\165B\165\169\150\222Z\244D\227*\189";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
