...
(* OASIS_START *)
(* DO NOT EDIT (digest: 28c4cec80c81fca63ef53e4f03e896cc) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "http_server.ml"});
               Executable
                 ({
                     cs_name = "echo_client";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\160\002\180lP\213\248\000G\019\225@@\139{\207";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
