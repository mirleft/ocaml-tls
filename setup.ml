...
(* OASIS_START *)
(* DO NOT EDIT (digest: dfa8f16e4da51a99a9d03b77df917b4f) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description = Some "TLS support on top of OCaml";
          categories = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources =
                        ["sha1.c"; "sha1.h"; "md5.c"; "md5.h"; "stubs.c"];
                      bs_data_files = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("asn1-combinators", None);
                   ...
                   },
                   {
                      ...
                      lib_pack = true;
                      lib_internal_modules = ["Asn_grammars"];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                      lib_findlib_containers = []
                   })
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\0161\209 \150\188\243\249,%y5Q\003Qn";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
