...
(* OASIS_START *)
(* DO NOT EDIT (digest: 224732768ea333bc700e77fc50cb6378) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Asn_grammars"; "Certificate"; "X509"];
                      lib_pack = false;
                      lib_internal_modules = ["List_ext"; "Registry"];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "$0G\020\248\134o\249\2103%\025\140\230B$";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
