...
(* OASIS_START *)
(* DO NOT EDIT (digest: ee39a6aee53bbcde499cd33bf25f402e) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Readertests"; "Unittests"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "unittests/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "unittests"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\014\170\242n\t5\205\002^&:6\150\230\129\030";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
