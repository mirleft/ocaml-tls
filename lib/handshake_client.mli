...
val default_client_hello : Config.config -> (client_hello * handshake_params * tls_version)
...
val answer_hello_request : epoch_data -> handshake_state -> handshake_return or_error
