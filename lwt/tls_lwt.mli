...
val read  : socket -> Cstruct.t -> int Lwt.t
val write : socket -> Cstruct.t -> int Lwt.t

val server_of_fd : o_server ->                Lwt_unix.file_descr -> socket Lwt.t
val client_of_fd : o_client -> host:string -> Lwt_unix.file_descr -> socket Lwt.t

val accept  : o_server -> Lwt_unix.file_descr -> (socket * Lwt_unix.sockaddr) Lwt.t
val connect : o_client -> string * int -> socket Lwt.t
