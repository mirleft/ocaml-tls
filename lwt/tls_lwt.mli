...
val client_of_fd : ?cert:X509_lwt.cert -> ?host:string -> Lwt_unix.file_descr -> socket Lwt.t

val accept  : ?cert:X509_lwt.cert -> Lwt_unix.file_descr -> (socket * Lwt_unix.sockaddr) Lwt.t
val connect : ?fd:Lwt_unix.file_descr -> ?cert:X509_lwt.cert -> host:string -> port:string -> socket Lwt.t
